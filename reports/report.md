...
Значениями ячеек(значение каждого пикселя) явлются числа от 0 до 1, которые обозначают "темноту" пикселя(0 - белый или пустой, 1 - абсолютно черный, 0,5 - серый)
...
![Precision = TPTP+FP](http://quicklatex.com/cache3/01/ql_a5772d63d24cdd677e66793b8854c201_l3.png "Precision = TPTP+FP")

![Precision = TPTP+FP](http://quicklatex.com/cache3/01/ql_a5772d63d24cdd677e66793b8854c201_l3.png "Precision = TPTP+FP")

![Recall = TPTP+FN](http://quicklatex.com/cache3/4f/ql_945273515acdb91bf287ffeb1b9a4b4f_l3.png "Recall = TPTP+FN")
